    ...
    return (
        <div className="w-4/5 mx-auto">
            <div className={"w-full flex items-center justify-between"}>
                ...
                <div className={"w-1/5 items-end place-items-end"}>
                    <Avatar>
                                    ...
                                    <Select>
                                        ...
                                        <SelectContent>
                                            <SelectGroup>
                                                ...
                                                <SelectItem value="apple">Eventos técnicos cientificos</SelectItem>
                                        ...
                                        <Select>
                                            ...
                                            <SelectContent>
                                                <SelectGroup>
                                                    ...
                                                    <SelectItem value="apple">Associação em sociedade cientifica (ex. SBC, IEEE, ACM).</SelectItem>
                                                    <SelectItem value="banana">Banana</SelectItem>
                                                    <SelectItem value="blueberry">Blueberry</SelectItem>
                                                    <SelectItem value="grapes">Grapes</SelectItem>
                                                    <SelectItem value="pineapple">Pineapple</SelectItem>
